...
function required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Webcreatives Core', // The plugin name.
			'slug'               => 'webcreatives-core', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/plugins/webcreatives-core.zip', // The plugin source.
	 ...
	 */
	$config = array(
		'id'           => 'webcreatives',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'webcreatives-install-plugins', // Menu slug.
