...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' && $_GET['action'] == "login") : ?>
...
<?php 
			echo '<div class="QapTcha qpt-register"></div>';
			echo '<script type="text/javascript">
				jQuery(document).ready(function($){
					$(".qpt-register").QapTcha({txtLock : "Csúsztasd el a bejelentkezéshez", txtUnlock : "Feloldva", disabledSubmit: false, autoSubmit: true});
				});
			</script>';	
?>	
